...
import { PrismaClient, Role, CourseLevel, ClassStatus } from '@prisma/client';
        ...
        create: [
          {
            ...
            options: { A: '52个', B: '56个', C: '60个', D: '88个' },
            correctAnswer: 'A',
            score: 20,
            orderIndex: 1,
          },
          {
            ...
            questionType: 'SINGLE_CHOICE',
            options: { A: '最左边', B: '正中间', C: '最右边', D: '没有固定位置' },
            correctAnswer: 'B',
            score: 20,
            orderIndex: 2,
          },
